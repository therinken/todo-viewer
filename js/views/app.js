...
app.AppView = Backbone.View.extend({
	...
	// existing skeleton of the App already present in the 
	// HTML.
	el: '#todoapp',
	...
	//'Todos' collection, when items are added or changed.
	initialize: function(){
	...
	// Re-rendering the App just means refreshing the statisitics
	...
	//Todo model, persisiting it to localStorage.
